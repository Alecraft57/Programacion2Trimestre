...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i=1;i<=cantlot;i++) {
            System.out.println("Pujas lote "+i+" : ");
            ...
            if (pujador1.getLote() > pujador2.getLote()) {
                System.out.println("El lote "+i+" es para " + pujador1);
            } else {
                System.out.println("El lote "+i+" es para: " + pujador2);
            }
        }
