...
//        vn.inserter();
//        vn.eliminar();
        Categoria cat=new Categoria("jocs","Juguetes de ruca");
//        cat.insertar();
//        cat.eliminar();
        article a=new article("K43123","Magdalenas",13.32,5,1,"jocs");
//        a.insertar();
//        a.eliminar();
        factura fac =new factura(6423,"2015-01-20",103,132,21,5);
//        fac.insertar();
//        fac.eliminar();
        linia_fac lf=new linia_fac(6423,2,"K43123",3,7.43,12);
//        lf.ingresar();
//        lf.eliminar();
